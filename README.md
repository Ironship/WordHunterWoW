...
- Previous / Next in the word editor, on the row with Cancel and Save (also the arrow keys when no box has focus, and LB/RB on a controller), so a quest can be read word by word without the mouse
