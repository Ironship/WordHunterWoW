...
function Addon.createEditor()
  editor = WHW_CreateFrame("Frame", "WordHunterWoWEditor", UIParent, "BackdropTemplate")
  Addon.editor = editor
  ...
  WHW_SetWordWrap(editor.context, true)
  ...
  WHW_SetWordWrap(editor.history, true)
  ...
  editor.noteScroll = WHW_MultilineEditBox(editor)
...
function Addon.updateResetDictionary()
  ...
  local dict = Addon.selected and Addon.selected.dictionaryEntry
  WHW_SetShown(editor.resetDictionary, dict ~= nil)
